            ...
            <div class="menu-container">
                ...
                <div class="menu-content">
                    <div class="menu-header">
                        <div class="menu-logo">
                            <img src="../assets/logo.png" alt="The Sinister Factory: Onde os Mistérios da Criação Foram Enterrados" class="menu-logo-img" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                        </div>
