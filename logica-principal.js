    ...
    showAchievements() {
        ...
        this.app.innerHTML = `
            <div class="achievements-container">
                <!-- Background image - Para adicionar imagem personalizada, coloque achievements-bg.png na pasta public -->
                <div class="achievements-bg-image" style="background-image: url('../assest/fundo.png');"></div>
                <div class="overlay-dark"></div>
                ...
                <div class="achievements-content">
                    <div class="achievements-header">
                        <!-- Header image - Para adicionar logo/imagem, coloque achievements-header.png na pasta public -->
                        <div class="achievements-header-image">
                            <img src="achievements-header.png" alt="Conquistas" class="achievements-logo" onerror="this.style.display='none';">
                        </div>
